...
//Tab初始化唐代诗人
    ...
    ans=$("#ans").val();
    ans_list=ans.split(",");
    poemer_name=ans_list[0];
    desty_name=ans_list[1];
    $("#search_name").val(poemer_name);
    ...
    function getSongByPage(page) {
        ...
        $.ajax({
            url: "/look_poemerByDestyAndName",
            type: "POST",
            data: {"desty": desty_name, "page": sql_page,"poemer_name":poemer_name},
            dataType: "json",
            async: true,
